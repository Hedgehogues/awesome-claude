...
const sections: LinkSection[] = [
  {
    title: 'Личное',
    items: [
      { url: 'https://www.linkedin.com/in/eurvanov/', label: 'LinkedIn' },
      { url: 'https://ru.stackoverflow.com/users/188116/eurvanov', label: 'Stack Overflow' },
      { url: 'http://github.com/hedgehogues/', label: 'GitHub' },
      { url: 'https://t.me/eurvanov', label: 'Telegram' },
      { url: 'https://vk.com/eurvanov', label: 'VK' },
      { url: 'https://getmentor.dev/mentor/egor-urvanov-1077', label: 'GetMentor' },
      ...
      { url: 'https://www.linkedin.com/in/eurvanov/details/honors/', label: 'LinkedIn · Достижения' },
    ],
  },
  {
    title: 'IT-комьюнити',
  ...
  },
  {
    ...
    items: [
      ...
      { url: 'https://getmentor.dev/mentor/egor-urvanov-1077', label: 'GetMentor · Профиль ментора' },
      { url: 'https://ysnit.mave.digital/ep-40', label: 'Подкаст · CTO Егор — человек ИТ-оркестр про страх кода, event storming и будущее с ИИ' },
      { url: 'https://www.youtube.com/watch?v=ycjmtkwQf8E', label: 'YouTube · Использование SDD фреймворков для детерминированной AI разработки' },
      ...
      { url: 'https://www.youtube.com/watch?v=bHewQCWJE2g', label: 'YouTube · Confluence/Jira. Transformers for Cayley' },
      { url: 'https://www.youtube.com/watch?v=V_bRcl6EjFk', label: 'YouTube · Golang by Rebrain. Сбор данных в интернете' },
      { url: 'https://www.youtube.com/watch?v=1LobFwBLel8', label: 'YouTube · Очумелые ручки беспилотников: Битва дата саентистов' },
    ],
  },
]
