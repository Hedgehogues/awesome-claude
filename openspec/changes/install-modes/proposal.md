...
- Расширить test-спеки `skills/sdd/<skill>/cases/<skill>.md` для всех sdd-скиллов до 4 категорий покрытия (см. `design.md` → D13)
...
- `sdd-test-coverage`: test-спеки `skills/sdd/<skill>/cases/<skill>.md` для всех sdd-скиллов
...
- `skills/skill/setup/skill.md` + `skills/skill/setup/cases/setup.md` — новый скилл
- `manifest.yaml` — новый файл в корне репы
- `skills/skill/deps/skill.md` + `skills/skill/deps/cases/deps.md` — новый скилл
- `skills/skill/onboarding/skill.md` + `skills/skill/onboarding/cases/onboarding.md` — новый скилл
- `skills/skill/release/skill.md` + `skills/skill/release/cases/release.md` — новый скилл
- `skills/sdd/<skill>/cases/<skill>.md` — расширение существующих test-spec'ов для sdd-скиллов
- `test-results/` — директория для файлов результатов прогонов
- `skills/skill/test-skill/stubs/with-change.md` — новый стаб
- `skills/skill/test-skill/skill.md` — обновление под eval-framework (после rename из шага 0)
