...
- [x] 7.2 Прогнать `skill:test-skill sdd:apply`, `skill:test-skill sdd:contradiction`, `skill:test-skill sdd:archive` локально — все кейсы зелёные.
- [x] 7.3 Прогнать `sdd:contradiction openspec/changes/structured-apply-output/` — без hard issues; warnings допустимы и обоснованы.
