...
awesome-claude SHALL operate in two modes. The mode determines what Claude does when invoked — not what the user runs manually. There are no public CLI commands for setup; Claude handles everything.
