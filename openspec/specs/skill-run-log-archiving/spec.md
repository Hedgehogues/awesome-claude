# skill-run-log-archiving Specification

## Purpose
Централизованное хранение логов выполнения SDD-скиллов в `.logs/<change-name>/` в корне репозитория. Охватывает все четыре скилла: sdd:contradiction, sdd:apply, sdd:propose, sdd:archive.
## Requirements
